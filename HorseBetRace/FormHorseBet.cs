...
namespace HorseBetRace
{
    public partial class FormHorseBet : Form
    {
        ...
        public void ResetRace() //Reset labels, bet amounts and horses back to start
        {
            ...
            foreach (var t in HorsesArray) t.Mypb.Left = t.StartingPosition;
            ...
            try
            {
                ...
                for (var i = 0; i < HorsesArray.Length; i++)
                    ...
                    ) // use Horse.run class for race if true return a winner and stop timer event
                    {
                        ...
                        for (var j = 0; j < MyPunters.Length; j++)
                        {
        ...
        public void HorsesRace() // Instantiate the Horses
        {
            ...
            {
                Mypb = pbHorse1, StartingPosition = pbHorse1.Left, HorseID = "#1",
                RaceTrackLength = pbRaceTrack.Width - pbHorse1.Width, Rand = new Random()
            };
            HorsesArray[1] = new Horse
            {
                Mypb = pbHorse2, StartingPosition = pbHorse2.Left, HorseID = "#2",
                RaceTrackLength = pbRaceTrack.Width - pbHorse2.Width, Rand = HorsesArray[0].Rand
            };
            HorsesArray[2] = new Horse
            {
                Mypb = pbHorse3, StartingPosition = pbHorse3.Left, HorseID = "#3",
                RaceTrackLength = pbRaceTrack.Width - pbHorse3.Width, Rand = HorsesArray[0].Rand
            };
            HorsesArray[3] = new Horse
            {
                Mypb = pbHorse4, StartingPosition = pbHorse4.Left, HorseID = "#4",
                RaceTrackLength = pbRaceTrack.Width - pbHorse4.Width, Rand = HorsesArray[0].Rand
            };
        }
